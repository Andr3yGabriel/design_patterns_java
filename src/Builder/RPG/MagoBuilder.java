...
public class MagoBuilder implements IPersonagemBuilder {
    ...
    public Personagem build() {
        ...
        if (personagem.inteligencia < 25) throw new IllegalStateException("Mago deve ter ao menos 25 pontos em Inteligência.");
        return personagem;
    }
}
